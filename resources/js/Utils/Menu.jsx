        ...
        },
        {
            ...
            details: [
                ...
                },
                {
                    ...
                    href: route("transactions.details"),
                    active: url === "/dashboard/transactions/details" ? true : false, // Update comparison here
                    icon: <IconShoppingCart size={20} strokeWidth={1.5} />,
                    permissions: hasAnyPermission(["transactions-access"]),
                },
            ],
            ...
            details: [
                {
                    ...
                    active: url === "/dashboard/invoices" ? true : false, // Update comparison here
                    icon: <IconShoppingCart size={20} strokeWidth={1.5} />,
                    permissions: hasAnyPermission(["transactions-access"]),
                }
            ],
